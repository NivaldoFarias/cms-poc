 ...
 */
type WithPWA = (nextConfig: NextConfig) => NextConfig & PluginOptions;
 ...
 */
declare const withPWA: (nextConfig: NextConfig) => NextConfig & PluginOptions;

/**
 * Returns a function constructor for a PWA-ready plugin to Next.js's configuration object.
 *
 * @param pluginOptions The **next-pwa** plugin configuration options.
 *
 * @see [Basic usage](https://github.com/shadowwalker/next-pwa#basic-usage)
 */
declare function nextPWA(pluginOptions: PluginOptions): typeof withPWA;
